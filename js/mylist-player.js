...
function doAjaxCallStuff(n) {
	...
	// create cookie to remember last video watched
	//document.cookie = 'vCookie1=0; expires=Fri, 3 Jan 2020 20:47:11 UTC; path=/';
	...
	$.ajax({
	  ...
	  success: function(data) {
			...
			$.each(data.items, function(i, val) {
		        ...
		        var thumb = "https://img.youtube.com/vi/"+ videoID +"/0.jpg";
...
vid_frame[m] = new YT.Player('vid_frame'+m, {
  // allowfullscreen: '0', // uncomment to disable full screen
  height: '720',
  width: '1280',
  playerVars: { 'html5': 1, 'autoplay': 0, 'rel': 0, 'controls': showPlayerControls, 'fs': 1, 'playsinline': 1, 'vq': 'hd1080' },
  videoId: vidIDs[n][0],
  events: {
...
function onPlayerStateChange(event) {
	...
	//document.cookie = 'vCookie'+n+'=0; expires=Fri, 3 Jan 2020 20:47:11 UTC; path=/';
	document.cookie = 'vCookie0='+listNum;
	console.log("onchange cookies: "+document.cookie);
